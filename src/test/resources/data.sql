INSERT INTO dbo.sports (sport_id, sport_name)
VALUES
(1, 'Football'),
(2, 'Volleyball'),
(3, 'Basketball');

INSERT INTO dbo.teams (team_id, team_name, sport_id)
VALUES
(1, 'Women Football', 1),
(2, 'Men Football', 1),
...
INSERT INTO dbo.user_types (user_type_id, user_name)
VALUES
(1, 'COACH'),
(2, 'PLAYER');

INSERT INTO dbo.users (user_id, user_type_id, first_name, last_name, email, team_id, age, gender, phone)
VALUES
...
INSERT INTO dbo.activity_types(activity_type_id, activity_type_name)
VALUES
(1, 'MATCH'),
(2, 'TRAINING');

INSERT INTO dbo.locations(location_id, court_name)
VALUES
(1, 'Football Pitch 1'),
(2, 'Football Pitch 2'),
...
INSERT INTO dbo.reservations(reservation_id, date_time, location_id)
VALUES
...
INSERT INTO dbo.ACTIVITIES(ACTIVITY_ID, ACTIVITY_NAME, CAPACITY, DESCRIPTION, CREATOR_ID, ACTIVITY_TYPE_ID, IS_CANCELLED, RESERVATION_ID, TEAM_ID)
VALUES
...
INSERT INTO dbo.ACTIVITY_STATUSES(STATUS_ID, USER_ID, ACTIVITY_ID)
VALUES
(1,3,1),
(1,3,2);
